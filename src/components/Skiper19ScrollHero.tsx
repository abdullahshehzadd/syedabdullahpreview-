            ...
            >
              ...
              <div className="lg:col-span-6 relative">
                ...
                >
                  ...
                  <div className="absolute top-3.5 right-3.5 flex items-center gap-2">
                    ...
                    <div className="bg-[#011207]/90 backdrop-blur-md px-3 py-1 rounded-lg border border-[#8BC53D]/40 text-xs sm:text-sm font-black text-[#8BC53D] shadow-md">
              ...
              <div className="lg:col-span-6 flex flex-col justify-center space-y-3 sm:space-y-4">
                ...
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div className="inline-flex items-center gap-1.5 text-xs font-bold text-[#8BC53D] uppercase tracking-wider">
                    <Flame className="w-3.5 h-3.5" />
                    <span>{activeItem.categoryLabel}</span>
                  </div>
                  
                  <div className="inline-flex items-center gap-1 text-[11px] text-[#E2F0CC]/70 bg-[#011207] px-2 py-0.5 rounded-md border border-[#8BC53D]/20">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wider text-[#8BC53D] mb-1.5 font-bold">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {activeItem.tags.map((t, idx) => (
                      <span
                        key={idx}
                        className="px-2 py-0.5 rounded-md bg-[#011207] border border-[#8BC53D]/25 text-[#E2F0CC] text-[11px] font-medium"
                      >
                        {t}
                      </span>
                    ))}
                ...
                <div className="flex items-center justify-between pt-1 text-[11px] text-[#E2F0CC]/60">
